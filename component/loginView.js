...
import { Button,Text,Image, TextInput, View,StyleSheet,Dimensions } from 'react-native';
//import loginInput from './inputBlock.js'
...
class Login extends Component {
  render() {
    ...
    <View style={[styles.inputBlock,styles.box2]}>
    <Text>Password</Text>
    <TextInput > </TextInput>
    </View>
